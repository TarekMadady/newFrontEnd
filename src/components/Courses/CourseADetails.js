  ...
  const fetchCourseData = async () => {
    try {
      const response = await fetch(
        `http://34.41.175.203:8000/course/${courid}`,
        {
          method: "GET",
          headers: {
            Authorization: `${token}`,
        ...
        {courVideos &&
          courVideos.map((c) => (
            <VideoCard
              ...
              videoid={c.video}
              cl={() =>
                showVideo(`http://34.41.175.203:8000/video/show/${c.video}`)
              }
              vi={getvid}
            />
          ))}
...
//   const fetchCourseData = async () => {
//     try {
//       const response = await fetch(`http://34.41.175.203:8000/course/${courid}`, {
//         method: "GET",
//         headers: {
//           Authorization: `${token}`,
//         },
