...
const CourseCard = ({
    ...
    return ( <
        ...
        li className = "my-4" >
        <
        Link className = "text-white fs-1 fw-bold"
        onClick = {
          displayInsta
        } >
        التعليمات <
        ...
        div className = "col-9 pt-5" > {
          showInsta ? ( <
            ...
            عزيزى الطالب يجب اتباع الخطوات التالية لضمان اتمام دراسة الموديل بنجاح <
            /h2> <
            ul > {
              couinsta && couinsta.map((c, idx) => < li className = "fw-bold fs-3"
                key = {
                  idx
                } > {
                  c
              ...
              showTag ? ( <
                ...
                /h2> <
                ul > {
                  targ && targ.map((c, idx) => < li className = "fs-3 fw-semibold"
                    key = {
                      idx
                    } > {
                      c
