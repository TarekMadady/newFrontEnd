      ...
      <div className="col-9 pt-5">
        {showInsta ? (
          <div dir="rtl" className="mt-2">
            ...
            <ul>
              {couinsta && couinsta.map((c, idx) => <li className="fw-bold fs-3" key={idx}>{c}</li>)}
            </ul>
                </div>
                <div className="col-6">
                <img
        ...
        {showTag ? (
          <div dir="rtl" className="mt-2">
            ...
            <ul>{targ && targ.map((c, idx) => <li className="fs-3 fw-semibold" key={idx}>{c}</li>)}</ul>
              </div>
              <div className="col-6">
              <img
              src="/images/tag.gif"
