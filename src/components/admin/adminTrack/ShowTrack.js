...
const ShowTrack = () => {
    ...
    const myData = async () => {
      const response = await fetch("https://tutorialbackend.onrender.com/admin/track/all", {
        method: "GET",
        headers: {
          Authorization: `${token}`,
        },
