...
const CourseOne = () => {
  ...
  return ( <
    ...
    /div> <
    CourseBaseData hour = {
      courseD && courseD.courseDetails.courseHour
    }
    Author = {
      courseD && courseD.courseDetails.courseAuthor
    }
    About = {
      courseD && courseD.courseDetails.aboutcourse
    }
    /> <
    /div> <
    /div> <
