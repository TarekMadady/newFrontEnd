  ...
  return ( <
    > {
      showPanel ? ( <
        ...
        /strong> <
        br / >
        يهدف هذا الإختبار إلى قياس الجوانب المعرفية لمهارات انتاج الرسومات المتحركة ثنائية وثلاثية الأبعاد لدى طلاب كلية التربية. <
        br / >
        <
        strong className = "text-primary h1 fw-bold" >
        تعليمات الإختبار:
        ...
        ol dir = "rtl" >
        <
        li > يحتوى هذا الإختبار على جزئين؛ جزء خاص بأسئلة الإختيار من متعدد، وجزء خاص لأسئلة الصواب والخطأ. <
        /li> <
        li >
        سوف يتم الإجابة بإستخدام مؤشر الفارة <
        /li> <
        li >
        -مدة الإختبار 30 دقيقة <
        /li> <
        li >
        لا يمكن تعديل الإجابات فى الإختبار بعد تسليمها <
        /li> <
        li >
        بعد الإنتهاء من حل السؤال انقر على زر التالي للإنتقال للسؤال التالي <
        /li> <
        li >
        بعد لإنتهاء من الإجابة عن جميع الأسئلة انقر فوق زر انهاء الإختبار؛ لتظهر نتيجة الإختبار <
        /li> <
        li >
        نسبة النجاح فى الإختبار من 85 %
        <
        /li> <
        /ol> <
        /p> <
